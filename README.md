...
# Decision-Tree-Admission-mini-project with AdaBoost and XGBoost.
programming language used: Python<br>
this was just trying to imply the XGBoost Regressor method and comparing it with the Regressor Decision tree (didnt yield better results), and implying the AdaBoost method and comparing it with the Classifier Decision tree (yielded much better results).
colab link (for trees display): https://colab.research.google.com/drive/1097cHmhZFFpM_PgEqtaL580NoBycCYr8#scrollTo=rlZUksVl2FI3
